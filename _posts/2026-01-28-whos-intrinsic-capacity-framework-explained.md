...
The [World Health Organization's Intrinsic Capacity Framework]({{ '/2025/12/senior-health-fast-changing-world.md' | relative_url }}) offers a comprehensive approach to understanding and [enhancing the well-being of older adults]({{ '/2024/06/tbi-in-older-adults-fall-prevention-recovery.md' | relative_url }}). This framework emphasizes the importance of intrinsic capacity, which encompasses an individual's physical and mental abilities.
...
* **Risk:** Untreated sensory loss is associated with cognitive decline and [increased mortality risk]({{ '/2024/04/psoriasis-metabolic-syndrome-mortality-risk.md' | relative_url }}).
