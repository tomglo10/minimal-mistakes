...
![Image of the portal venous system and esophageal varices]({{ site.urlimg }}{{ site.urlimg }}/assets/images/esophageal-varices.webp)
...
**March 2026 Clinical Update:</strong> Our site advocacy now prioritizes high-protein intake ($1.2\text{--}1.5 \text{ g/kg}$) to combat liver-related sarcopenia. Portal hypertension targets are set at a systemic blood pressure of $<130/80 \text{ mmHg}$.
</div>
