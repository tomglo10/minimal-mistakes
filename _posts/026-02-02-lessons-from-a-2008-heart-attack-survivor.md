...
![Senior Heart Health]({{ site.urlimg }}{{ site.urlimg }}{{ '/assets/img/heart-health.webp' | relative_url }})
{: .normal }
...
![Coronary Artery Disease]({{ site.urlimg }}{{ site.urlimg }}{{ '/assets/img/coronary-artery-disease.webp' | relative_url }})
{: .normal }
...
![Valve Stenosis Comparison]({{ site.urlimg }}{{ site.urlimg }}{{ '/assets/img/medical-illustration.webp' | relative_url }})
{: .normal }
...
![Aortic Stenosis Detail]({{ site.urlimg }}{{ site.urlimg }}{{ '/assets/img/aortic-stenosis.webp' | relative_url }})
{: .normal }
